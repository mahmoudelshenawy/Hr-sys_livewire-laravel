...
class PayrollAbsencePenaltiesTable extends LivewireDatatable
{
    ...
    {
        return PayrollAbsencePenalty::query();
    }
    ...
    {
        PayrollAbsencePenalty::where('id', '=', $id)->delete();
    ...
    public function columns()
    {
        return [
            ...
            NumberColumn::name('days')->filterable()->searchable()->label('Absence Days'),
            NumberColumn::name('amount')->filterable()->searchable(),
            Column::callback(['id'], function ($id) {
                return view('components.edit-table-btn', ['key' => $id, 'name' => 'Value', 'for' => 'addPayrollAbsencePenalty']);
            })->label('Edit'),
