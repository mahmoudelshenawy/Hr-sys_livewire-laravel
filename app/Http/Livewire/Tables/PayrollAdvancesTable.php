...
class PayrollAdvancesTable extends LivewireDatatable
{
    ...
    {
        PayrollAdvance::where('id', '=', $id)->delete();
    ...
    public function columns()
    {
        return [
            ...
            Column::callback(['id'], function ($id) {
                return view('components.edit-table-btn', ['key' => $id, 'name' => 'Value', 'for' => 'addPayrollAdvance']);
            })->label('Edit'),
