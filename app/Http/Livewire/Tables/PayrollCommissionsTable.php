...
class PayrollCommissionsTable extends LivewireDatatable
{
    ...
    {
        return PayrollCommission::query();
    }
    ...
    {
        PayrollCommission::where('id', '=', $id)->delete();
    ...
    public function columns()
    {
        return [
            ...
            Column::callback(['id'], function ($id) {
                return view('components.edit-table-btn', ['key' => $id, 'name' => 'Value', 'for' => 'addPayrollCommission']);
            })->label('Edit'),
