<div class="modal effect-slide-in-bottom fade" id="deleteEducation">
    <div class="modal-dialog modal-dialog-centered modal-content-demo" role="document">
        <div class="modal-content tx-size-sm">
            <form wire:submit.prevent="remove({{ $id }})" id="deleteEducationForm" onsubmit="test()">
...
<script>
    ...
    $(document).ready(function(){
        $('#deleteEducationForm').on('submit' , function(){
               $('#deleteEducation').modal('hide');
           })
    })
</script>
