<div class="modal effect-slide-in-bottom fade" id="deleteInsurrance">
    <div class="modal-dialog modal-dialog-centered modal-content-demo" role="document">
        <div class="modal-content tx-size-sm">
            <form wire:submit.prevent="remove({{ $id }})" id="deleteInsurranceForm" onsubmit="test()">
...
<script>
    function test(){
        $('#deleteInsurrance').modal('hide');
    }
    $(document).ready(function(){
        $('#deleteInsurranceForm').on('submit' , function(){
               $('#deleteInsurrance').modal('hide');
           })
    })
</script>
