<div class="modal effect-slide-in-bottom fade" id="deleteLanguage">
    <div class="modal-dialog modal-dialog-centered modal-content-demo" role="document">
        <div class="modal-content tx-size-sm">
            <form wire:submit.prevent="remove({{ $id }})" id="deleteLanguageForm" onsubmit="test()">
...
<script>
    ...
    $(document).ready(function(){
        $('#deleteLanguageForm').on('submit' , function(){
               $('#deleteLanguage').modal('hide');
           })
    })
</script>
