<div class="modal effect-slide-in-bottom fade" id="deleteSkill">
    <div class="modal-dialog modal-dialog-centered modal-content-demo" role="document">
        <div class="modal-content tx-size-sm">
            <form wire:submit.prevent="remove({{ $id }})" id="deleteSkillForm" onsubmit="test()">
...
<script>
    ...
    $(document).ready(function(){
        $('#deleteSkillForm').on('submit' , function(){
               $('#deleteSkill').modal('hide');
           })
    })
</script>
