<div class="modal effect-slide-in-bottom fade" id="deleteCertification">
    <div class="modal-dialog modal-dialog-centered modal-content-demo" role="document">
        <div class="modal-content tx-size-sm">
            <form wire:submit.prevent="remove({{ $id }})" id="deleteCertificationForm" onsubmit="test()">
...
<script>
    ...
    $(document).ready(function(){
        $('#deleteCertificationForm').on('submit' , function(){
               $('#deleteCertification').modal('hide');
           })
    })
</script>
