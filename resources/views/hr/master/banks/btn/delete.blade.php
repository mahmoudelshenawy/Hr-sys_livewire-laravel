<div class="modal effect-slide-in-bottom fade" id="deleteBank">
    <div class="modal-dialog modal-dialog-centered modal-content-demo" role="document">
        <div class="modal-content tx-size-sm">
            <form wire:submit.prevent="remove({{ $id }})" id="deleteBankForm" onsubmit="test()">
...
<script>
    ...
    $(document).ready(function(){
        $('#deleteBankForm').on('submit' , function(){
               $('#deleteBank').modal('hide');
           })
    })
</script>
