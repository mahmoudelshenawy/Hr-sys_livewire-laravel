<div class="flex space-x-1 justify-around">
    <a class="p-1 text-teal-600 hover:bg-teal-600 hover:text-white rounded" href="{{ url('/hr/employees/' .$code . '/profile') }}">
    ...
    <a data-toggle="modal" href="#addEmployee" wire:click="$emit('findEmployee' , {{$code}})" class="p-1 text-blue-600 hover:bg-blue-600 hover:text-white rounded">
