<div class="modal effect-scale fade"  id="addInsurranceCompany" wire:ignore.self>
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document"  data-container="#addInsurranceCompany">
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-body">
               <div class="row">
                   <div class="col-sm-6">
                    <x-form-group title="Insurrance Company name" for="name" name="insurrance.name"/>
                   </div>
                   <div class="col-sm-6">
                    <x-form-group title="Insurrance Code" for="code" name="insurrance.code"/>
                   </div>
                   <div class="col-sm-6">
                    <x-form-group title="Address" for="address" name="insurrance.address"/>
                   </div>
                   <div class="col-sm-6">
                    <x-form-group title="contact number" for="number" name="insurrance.contact_number"/>
                   </div>
            </div>
            <br>
